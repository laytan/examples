...
main :: proc() {
	...
	nbio.dial(net.Endpoint{net.IP4_Loopback, 1234}, on_dial)
	...
	on_dial :: proc(op: ^nbio.Operation) {
		...
		FILE ::"/run/media/laytan/Elements/media/Movies/Die Hard (1988)/Die.Hard.1988.REPACK.UHD.BluRay.2160p.DDP.5.1.DV.HDR.x265-hallowed.mkv"
		// FILE ::"/home/laytan/projects/nais/examples/uoh.mkv"
